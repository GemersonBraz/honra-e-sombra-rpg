            ...
            <div class="card p-8 border-2 border-border/50 shadow-2xl">
                <div class="text-center mb-8">
                    <div class="flex justify-center mb-4">
                        <div class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center">
                            <img src="<?= $basePath ?>img/icons-1x1/lorc/crossed-swords.svg" alt="Espadas Cruzadas" class="w-8 h-8 icon-primary">
                        </div>
                    </div>
                ...
                <form method="POST" action="index.php?page=login" class="space-y-6">
                    ...
                    <button type="submit" 
                        ...
                        <img src="<?= $basePath ?>img/icons-1x1/lorc/magic-gate.svg" alt="Entrar" class="w-5 h-5 icon-white mr-2">
                        Entrar no Reino
                    </button>
                </form>
                ...
                <div class="mt-6 text-center">
                    <p class="text-text/70 font-heading">
                        ...
                        <a href="index.php?page=register" class="text-primary hover:text-accent font-medium flex items-center justify-center">
                            <img src="<?= $basePath ?>img/icons-1x1/lorc/edged-shield.svg" alt="Registrar" class="w-4 h-4 icon-primary mr-1">
                            Junte-se à Ordem
                        </a>
                    </p>
                </div>
